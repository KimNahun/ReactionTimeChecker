// Views/MultiTap/MultiTapHomeView.swift
import SwiftUI
import TopDesignSystem

struct MultiTapHomeView: View {
    let onStart: () -> Void
    var onBack: (() -> Void)? = nil
            ...
            VStack(spacing: 0) {
                ...
                ScrollView {
                    VStack(spacing: DesignSpacing.lg) {
                        ...
                        Text(String(localized: "Multi-Tap"))
                            .font(.ssTitle1)
                        ...
                        Text(String(localized: "Tap as many circles as you can!"))
                            .font(.ssBody)
                        ...
                        SurfaceCard(elevation: .raised) {
                            VStack(spacing: DesignSpacing.md) {
                                ...
                                VStack(alignment: .leading, spacing: DesignSpacing.sm) {
                                    ruleRow(icon: "1.circle.fill", text: String(localized: "Circles, triangles, and squares appear rapidly"))
                                    ruleRow(icon: "2.circle.fill", text: String(localized: "Tap ONLY circles — ignore other shapes!"))
                                    ruleRow(icon: "3.circle.fill", text: String(localized: "Wrong tap = -2 seconds! You have 20 seconds"))
                                }
                            }
